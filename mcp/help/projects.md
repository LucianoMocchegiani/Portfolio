...
Cuando pregunten “qué proyectos hiciste”, respondé en **prosa**, 2–3 oraciones. Usá links markdown `[Nombre](url)`. **No uses viñetas** ni pongas la URL entre paréntesis: abajo ya se pintan las cards.
...
## Propios
- Kuatia — https://kuatia.xyz/ — topic `kuatia`
- Faciliter — https://faciliter.xyz/ — topic `faciliter`

## Asignados (el más reciente primero)
- BAX — https://bax.buenosaires.gob.ar/ — topic `bax` (Phinx Lab, oct. 2024 — actualidad)
- QuarkID — https://buenosaires.gob.ar/gcaba_historico/jefaturadegabinete/innovacionytransformaciondigital/quarkid — topic `quarkid`
- Servicios BA — topic `servicios-ba`
